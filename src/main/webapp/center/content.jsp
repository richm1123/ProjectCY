...
%>
		<div class="main-cont">
			...
			<table id="notice">
				...
				<tr><td>파일</td><td colspan="3"><a href="../upload/<%=boardDTO.getFile() %>" download><%=boardDTO.getFile() %></a></td></tr>
				<tr><td>내용</td><td colspan="3" class="cont"><%=boardDTO.getContent() %>
				<img src="../upload/<%=boardDTO.getFile() %>" width="300"height="auto">
				</td></tr>
			</table>
...
<%-- 		onclick="location.href='delete.jsp?num=<%=boardDTO.getNum()%>'">   --%>
				...
				<script>
					function next(){
 						if(confirm("삭제하시겠습니까?"))
 						{
  							location.href="delete.jsp?num=<%=boardDTO.getNum()%>";
 						}
					}
				</script>
